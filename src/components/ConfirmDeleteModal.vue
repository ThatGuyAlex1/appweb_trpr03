...
const emit = defineEmits(['onDeleteConfirmed'])
...
onMounted(() => {
  ...
  if (document.querySelector('#confirm-delete-modal')) {
    modal.value = new Modal('#confirm-delete-modal')
  }
})
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button name="annuler" type="button" data-bs-dismiss="modal" class="btn btn-secondary">
            {{ cancelButton }}
          </button>
        </div>
      </div>
